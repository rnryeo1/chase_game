...
public class directionAreaLauncher : MonoBehaviour
{
    [SerializeField] GameObject m_directionarrow = null;
    //public GameObject m_recochet = null;
    [SerializeField] Transform m_directionSpawn = null;
    ...
    public void shoot()
    {
        ...
        GameObject go = Instantiate(m_directionarrow, m_directionSpawn.position, Quaternion.identity);
        go.GetComponent<directionArea>().setSkillCount(skillCount);
        //directionArea mr = go.GetComponent<directionArea>();
        //mr.direction = bulDir;
        //angle += angleStep;
        //}
