...
{
    [SerializeField] GameObject m_spark = null;
    //public GameObject m_recochet = null;
    [SerializeField] Transform m_sparkSpawn = null;
    ...
    void initSparkbeforeDestroy()
    {
        //for (int i = 0; i < colmulautodirStack; i++)
        //{
        GameObject t_missile = Instantiate(m_spark, m_sparkSpawn.position, Quaternion.identity);
        t_missile.GetComponent<SparkObj>().setSkillCount(skillCount);
        //}
    }
