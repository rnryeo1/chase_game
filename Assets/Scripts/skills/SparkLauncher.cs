...
{
    [SerializeField] GameObject m_Sparkarrow = null;
    ...
    public void shoot()
    {
        ...
        GameObject go = Instantiate(m_Sparkarrow, m_SparkSpawn.position, Quaternion.identity);
        Spark mr = go.GetComponent<Spark>();
