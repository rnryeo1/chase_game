...
public class ColMulAutoDir : MonoBehaviour
{
    [SerializeField] GameObject m_colmulautodirarrow = null;
    //public GameObject m_recochet = null;
    [SerializeField] Transform m_colmulautodirSpawn = null;
    ...
    int skillCount = 1;
    [SerializeField] private int colmulautodirStack = 1;
    ...
    {
        SearchEnemy();
        yield return new WaitForSeconds(2);//5초간있을경우 제자리에서 삭제 
    ...
    void initAutoDirObjbeforeDestroy()
    {
        // for (int i = 0; i < skillCount; i++)
        // {
        //     GameObject t_missile = Instantiate(m_colmulautodirarrow, m_colmulautodirSpawn.position, Quaternion.identity);
        // }
