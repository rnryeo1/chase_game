...
public class ColMulAutoDiirLauncher : MonoBehaviour
{
    [SerializeField] GameObject m_autodirarrow = null;
    //public GameObject m_recochet = null;
    [SerializeField] Transform m_autodirSpawn = null;
    ...
    public void shoot()
    {
        ...
        GameObject go = Instantiate(m_autodirarrow, m_autodirSpawn.position, Quaternion.identity);
        ColMulAutoDir mr = go.GetComponent<ColMulAutoDir>();
