...
public class Parallaxer : MonoBehaviour
{
    ...
    public float playerApartPosX = 4.0f;
    ...
    void SpawnImmediate()
    {
        ...
        if (t == null) return; //if true , this indicates that poolsize is to small
        Vector3 pos = Vector3.zero;
        pos.x = ((player.transform.position.x + playerApartPosX + immediateSpawnPos.x) * Camera.main.aspect) / targetAspect;
